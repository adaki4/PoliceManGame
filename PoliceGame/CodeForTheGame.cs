...
namespace pb006 {
    ...
    public class Game
    {
        ...
        public void InitBoard(int width, int height) {
            ...
            agents.Add(new Agent(new Position(board.Count() - 2, board[0].Count() - 2), Direction.South));
            board[agents[^1].Position.x][agents[^1].Position.y] = agents[^1];
            objs.Add(agents[^1]);
        ...
        public void Update()
        {
            ...
            {
                obj.Update(GetNeighborhood(obj.Position), board);
            }
            SetObjectsToBoard();
